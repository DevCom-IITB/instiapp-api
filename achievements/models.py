...
class OfferedAchievement(models.Model):
    ...
    body = models.ForeignKey(
        "bodies.Body", on_delete=models.CASCADE, related_name="offered_achievements"
    )

    event = models.ForeignKey(
        "events.Event", on_delete=models.CASCADE, related_name="offered_achievements"
    )
    ...
    @classmethod
    def post_create(
        cls, sender, instance, created, *args, **kwargs
...
class Achievement(models.Model):
    ...
    body = models.ForeignKey(
        "bodies.Body", null=True, on_delete=models.SET_NULL, related_name="achievements"
    )
...
class Skill(models.Model):
    ...
    title = models.CharField(max_length=80)
    body = models.ForeignKey(
        "bodies.Body", on_delete=models.CASCADE, related_name="skills"
    )
