...
class Community(models.Model):
    ...
    body = models.ForeignKey('bodies.Body', on_delete=models.CASCADE, related_name='community_body')
...
class CommunityPostUserReaction(models.Model):
    ...
    user = models.ForeignKey('users.UserProfile', on_delete=models.CASCADE, related_name='ucpr')
    communitypost = models.ForeignKey(CommunityPost, on_delete=models.CASCADE, related_name='ucpr')
