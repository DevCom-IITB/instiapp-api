...
class Complaint(models.Model):
    ...
    users_up_voted = models.ManyToManyField(
        "users.UserProfile", related_name="users_up_voted", blank=True
    )
    authorities = models.ManyToManyField(
        ComplaintAuthority, related_name="complaints", blank=True
    )
    subscriptions = models.ManyToManyField(
        "users.UserProfile", related_name="subscriptions", blank=True
    )
...
class ComplaintComment(models.Model):
    ...
    commented_by = models.ForeignKey(
        "users.UserProfile", on_delete=models.CASCADE, related_name="commented_by"
    )
    complaint = models.ForeignKey(
