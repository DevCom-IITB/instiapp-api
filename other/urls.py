...
urlpatterns = [
    ...
    path(
        "notifications/read",
        OtherViewset.as_view({"get": "mark_all_notifications_read"}),
    ),
    path(
        "notifications/read/<pk>",
        OtherViewset.as_view({"get": "mark_notification_read"}),
    ),
    ...
    path(
        "test/notification", OtherViewset.as_view({"get": "create_test_notification"})
    ),
]
