...
class UserNewsReaction(models.Model):
    ...
    user = models.ForeignKey(
        "users.UserProfile", on_delete=models.CASCADE, default=uuid4, related_name="unr"
    )
    news = models.ForeignKey(
        NewsEntry, on_delete=models.CASCADE, default=uuid4, related_name="unr"
    )
