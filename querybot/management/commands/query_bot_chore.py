...
def fill_faq():
    ...
    creds = ServiceAccountCredentials.from_json_keyfile_name('querybot/cred.json', scope)
    service = discovery.build('sheets', 'v4', credentials=creds)
    spreadsheet_id = '1JYdfLpaExhR2pMXWouj9b-nxa6ztt1FRL8cBEqwdAic'
    range_ = 'sheet1!A:F'

    request = service.spreadsheets().values().batchGet(spreadsheetId=spreadsheet_id, ranges=range_,
